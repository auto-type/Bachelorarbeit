...
class sineWavFlow(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LernenWasGeht", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LernenWasGeht")
...
def main(top_block_cls=sineWavFlow, options=None):
