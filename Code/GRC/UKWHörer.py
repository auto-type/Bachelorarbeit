...
class UKWHörer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GreadScottGadgetsKurs", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GreadScottGadgetsKurs")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "UKWHörer")
        ...
        self.frequency = frequency = 97e6
        self.channel_width = channel_width = 200e3
        self.channel_freq = channel_freq = 97e6

        ##################################################
        # Blocks
        ##################################################

        self._volume_range = qtgui.Range(0, 2, 0.1, 1, 50)
        self._volume_win = qtgui.RangeWidget(self._volume_range, self.set_volume, "'volume'", "slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._volume_win)
        self._channel_freq_range = qtgui.Range(85e6, 105e6, channel_width/8, 97e6, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (frequency -channel_freq), 1, 0, 0)
    ...
    def set_frequency(self, frequency):
        ...
        self.analog_sig_source_x_0.set_frequency((self.frequency -self.channel_freq))
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.frequency, self.samp_rate)
...
def main(top_block_cls=UKWHörer, options=None):
